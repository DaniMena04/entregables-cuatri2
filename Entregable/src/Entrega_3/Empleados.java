...
public class Empleados {
    ...
    public static Empleados of() {
        if(Empleados.gestorDeEmpleados == null)
            Empleados.gestorDeEmpleados = Empleados.parse("C:\\Users\\Usuario\\git\\entrega-02-JAVA\\Entregable\\src\\fichero_banco\\empleados.txt");
	...
	public static void main(String[] args) {
		Empleados empleados = Empleados.parse("C:\\Users\\Usuario\\git\\entrega-02-JAVA\\Entregable\\src\\fichero_banco\\empleados.txt");
